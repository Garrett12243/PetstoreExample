...
class PetApi(
   ...
   * @return ApiResponse
   */
  def uploadFile(petId: Long, additionalMetadata: Option[String] = None, file: Option[Array[Byte]] = None): Option[ApiResponse] = {
   ...
   */
  def uploadFileAsync(petId: Long, additionalMetadata: Option[String] = None, file: Option[Array[Byte]] = None): Future[ApiResponse] = {
